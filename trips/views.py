...
#4 методы получения поездок(прошедшие, будущие, я водитель, я пассажир)
#методу отмены брони, методы отмены поездки для водителя, отмена брони для пассжаира, статус отмены брони для пассажиров
#чат
#в бд добавить фильтры 
#добавить методы фильтров
#метод получение поездки со всеми пассажирами и информацаии о них